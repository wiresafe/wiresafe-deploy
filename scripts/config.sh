...
export HS_SERVER_CONFIG_PATH=/data
export HS_LOCAL_CONFIG_PATH=${PROJECT_ROOT}/_private${HS_SERVER_CONFIG_PATH}
...
export IS_LOCAL_CONFIG_PATH=${PROJECT_ROOT}/_private${IS_SERVER_CONFIG_PATH}
